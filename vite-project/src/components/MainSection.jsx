    ...
    <div className="bg-bodyBg min-w-screen">
      <div className="grid lg:grid-cols-2 grid-cols-1 p-10 flex-wrap place-items-center gap-16 align-center lg:h-screen mt-0">
        <div className="flex flex-col">
          ...
          <div className="text-lg mb-6">
            BeyondSkill is proud of the many achievements of our students and
            instructors. Our aim is to provide the highest quality education and
      ...
      <div className="bg-darkBlue p-10 md:rounded-bl-[140px]">
        ...
        <div className="flex justify-between flex-wrap">
          ...
          <div className="border-2 border-white hover:bg-white hover:text-black hover:font-bold transition-colors rounded-md text-white p-3 flex justify-between md:mt-0 mt-4 cursor-pointer">
            <div className="mr-3">Explore Programs </div>
            <span>
      ...
      <div className="flex flex-col p-10">
        <div className="text-5xl font-semibold mb-10 leading-tight">
          Our proven results
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-16 place-items-center">
          <div className="flex flex-col bg-white p-4 h-fit rounded-tr-3xl hover:shadow-2xl transition-shadow duration-75 cursor-pointer border-gray-500">
            <div className="flex items-center mb-10">
              <div>
                <img src={enterprise} alt="" className="w-10 mr-3" />
              </div>
              <div className="text-sm font-medium">For Enterprise</div>
            </div>
            <div className="font-medium font-serif text-4xl mb-6">
              FORRESTER
            </div>
            <div className="font-medium text-2xl w-3/4">
              232% ROI reported with a payback period of under 3 months
            </div>
          </div>
          ...
          <div className="flex flex-col bg-white p-8 h-fit rounded-br-3xl hover:shadow-2xl transition-shadow duration-75 cursor-pointer border-gray-500">
            <div className="flex items-center mb-10">
              <div>
                <img src={govt} alt="" className="w-10 mr-3" />
              </div>
            ...
            <div className="font-medium text-2xl w-3/4">
              11,800+ graduates in Saudi Arabia transformed scholarships into
              careers
            </div>
          </div>
          ...
          <div className="flex flex-col bg-white p-8 h-fit rounded-tl-3xl hover:shadow-2xl transition-shadow duration-75 border-gray-500 cursor-pointer">
            <div className="flex items-center mb-10">
              <div>
                <img src={ind} alt="" className="w-10 mr-3" />
              </div>
